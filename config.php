...
define('DB_NAME', 'u203735599_ifixitmorcrm');
define('DB_HOST', 'localhost');
define('DB_USER', 'u203735599_ifixitmorcrm');
define('DB_PASSWORD', '&6?pbYXiF');


// Titulo de la aplicación
define('TITULO_APP', 'CRM IFIXITMOR');
